...
| ID         | Name               | Komponente | Typ    | Einheit | Schreibbar | Beschreibung                                                                                                                                                |
| ---------- | ------------------ | ---------- | ------ | ------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| 3wayvalve       | WWK 3-Wege-Ventil aktiv      | dhw        | boolean |         |            | AN bei Warmwasserbetrieb, ansonsten AUS - identisch zu schreibbarem _hp3way_                                  |
...
curl 'http://ems-esp/api/boiler/entities' | jq -r '[
  "| ID | Name | Komponente | Typ | Einheit | Schreibbar |",
  "|----|------|------------|-----|---------|------------|",
