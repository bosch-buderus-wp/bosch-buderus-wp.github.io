...
Dazu öffnet ihr auf der Oberfläche eures ems-esp zuerst den Menüpunkt `Individuelle Entitäten`.
Dort legt ihr euch eine neue Entität mit dem Namen `message` und dem Wert Typ `RAM-wert` an.
In dieser Entität wird die zu sendende Nachricht zwischengespeichert.

[![Screenshot: Individuelle Entität](https://i.ibb.co/7JF8W9nS/emsesp-ntfy-custom-entity.png)](https://i.ibb.co/7JF8W9nS/emsesp-ntfy-custom-entity.png)

Immer wenn sich diese Nachricht ändert, soll eine Benachrichtigung versendet werden.
Dazu wählt ihr im Menü den `Planer` aus und erstellt einen neuen Zeitplan, der...
