...
excerpt: "Overview of entities readable via EMS-ESP for Bosch CS5800/6800i and Buderus WLW176/186i."
...
Version 3.7.1 of [ems-esp](https://emsesp.org/) provides 166 entities for the boiler and 71 for the control element.
This page provides an explanation of all entities, insofar as they are known.
If anyone has additional information/corrections, feel free to add them.
...
_"meter..."_: electrical energy used (electricity consumption)
...
| [metertotal](http://ems-esp/api/boiler/metertotal) | Total metering    | boiler        | 🔢  | kWh     |     | Total **electrical energy used** by the **heat pump and auxiliary heater** for **heating, cooling and domestic hot water** - more precise version of _nrgconstotal_ |
| [metercomp](http://ems-esp/api/boiler/metercomp)   | Compressor metering | boiler       | 🔢  | kWh     |     | Total **electrical energy used** by the **heat pump** for **heating, cooling and domestic hot water** - more precise version of _nrgconscomptotal_ |
| [metereheat](http://ems-esp/api/boiler/metereheat) | Electric heater metering | boiler   | 🔢  | kWh     |     | Total **electrical energy used** by the **auxiliary heater** - more precise version of _auxelecheatnrgconstotal_                                      |
| [meterheat](http://ems-esp/api/boiler/meterheat)   | Heating metering  | boiler        | 🔢  | kWh     |     | Total **electrical energy used** for **heating**                                                                                                       |
| [meter](http://ems-esp/api/boiler/meter)           | DHW metering      | boiler<br>dhw | 🔢  | kWh     |     | Total **electrical energy used** for **domestic hot water**                                                                                            |
| [metercool](http://ems-esp/api/boiler/metercool)   | Cooling metering  | boiler        | 🔢  | kWh     |     | Total **electrical energy used** for **cooling**                                                                                                       |

### Without decimal places

_"nrgsupp..."_: generated thermal energy (heat)\
_"nrgcons..."_: electrical energy used (electricity consumption)\
_"nrgconscomp..."_: electrical energy used by the heat pump\
_"auxelecheatnrgcons..."_: electrical energy used by the electric auxiliary heater
...
| [nrgsupppool](http://ems-esp/api/boiler/nrgsupppool)                             | total energy output pool                  | boiler        | 🔢  | kWh     |     | -- presumably not relevant --                                                                                         |
| [nrgconstotal](http://ems-esp/api/boiler/nrgconstotal)                           | Total energy consumption                  | boiler        | 🔢  | kWh     |     | Total **electrical energy used** by the **heat pump and auxiliary heater** for **heating, cooling and domestic hot water** |
| [nrgconscomptotal](http://ems-esp/api/boiler/nrgconscomptotal)                   | Total energy consumption compressor       | boiler        | 🔢  | kWh     |     | Total **electrical energy used** by the **heat pump** for **heating, cooling and domestic hot water**              |
| [nrgconscompheating](http://ems-esp/api/boiler/nrgconscompheating)               | Energy consumption compressor heating     | boiler        | 🔢  | kWh     |     | Total **electrical energy used** by the **heat pump** for **heating**                                      |
| [nrgconscomp](http://ems-esp/api/boiler/nrgconscomp)                             | DHW energy consumption compressor         | boiler<br>dhw | 🔢  | kWh     |     | Total **electrical energy used** by the **heat pump** for **domestic hot water**                                   |
| [nrgconscompcooling](http://ems-esp/api/boiler/nrgconscompcooling)               | Energy consumption compressor cooling    | boiler        | 🔢  | kWh     |     | Total **electrical energy used** by the **heat pump** for **cooling**                                      |
| [nrgconscomppool](http://ems-esp/api/boiler/nrgconscomppool)                     | Energy consumption compressor pool       | boiler        | 🔢  | kWh     |     | -- presumably not relevant --                                                                                       |
| [auxelecheatnrgconstotal](http://ems-esp/api/boiler/auxelecheatnrgconstotal)     | Energy consumption electric auxiliary heating | boiler   | 🔢  | kWh     |     | Total **electrical energy used** by the **auxiliary heater** for **heating and domestic hot water**                        |
| [auxelecheatnrgconsheating](http://ems-esp/api/boiler/auxelecheatnrgconsheating) | Energy consumption electric auxiliary heating | boiler | 🔢  | kWh     |     | Total **electrical energy used** by the **auxiliary heater** for **heating**                                       |
| [auxelecheatnrgcons](http://ems-esp/api/boiler/auxelecheatnrgcons)               | DHW energy consumption electric auxiliary heating | boiler<br>dhw | 🔢 | kWh |     | Total **electrical energy used** by the **auxiliary heater** for **domestic hot water** |
| [auxelecheatnrgconspool](http://ems-esp/api/boiler/auxelecheatnrgconspool)       | Energy consumption electric auxiliary heating pool | boiler | 🔢 | kWh | | -- presumably not relevant -- |
...
| [dampedoutdoortemp](http://ems-esp/api/thermostat/dampedoutdoortemp) | Damped outdoor temperature         | thermostat        | 🔢  | °C   |     | [Damped outdoor temperature](/en/docs/einstellungen/#d%C3%A4mpfung-der-au%C3%9Fentemperatur) - see also _damping_         |
...
| [hptc3](http://ems-esp/api/boiler/hptc3)                             | Condenser temperature (TC3)        | boiler            | 🔢  | °C   |     | Refrigerant temperature when entering the condenser                                                           |
| [hptr1](http://ems-esp/api/boiler/hptr1)                             | Compressor temperature (TR1)         | boiler            | 🔢  | °C   |     | Refrigerant temperature in the compressor                                                                               |
| [hptr3](http://ems-esp/api/boiler/hptr3)                             | Refrigerant (liquid) (TR3)        | boiler            | 🔢  | °C   |     | Refrigerant temperature when leaving the condenser                                                            |
| [hptr4](http://ems-esp/api/boiler/hptr4)                             | Evaporator inlet (TR4)            | boiler            | 🔢  | °C   |     | Refrigerant temperature after the expansion valve                                                                  |
...
| [hptl2](http://ems-esp/api/boiler/hptl2)                             | Outdoor air inlet temperature (TL2) | boiler          | 🔢  | °C   |     | Air temperature at the evaporator inlet                                                                                     |
...
| [targetflowtemp](http://ems-esp/api/thermostat/targetflowtemp)       | HC1 calculated flow temperature   | thermostat<br>hc1 | 🔢  | °C | | The target flow temperature determined by the system (with PV surplus _targetflowtemp_ = _selflowtemp_ + _pvraiseheat_) |
...
| [designtemp](http://ems-esp/api/thermostat/designtemp)   | HC1 design temperature                                           | thermostat<br>hc1 | 🔢 | °C | ✔ | [Flow temperature at the design outdoor temperature](/en/docs/einstellungen/#vorlauftemperatur-nat) |
...
| [minexttemp](http://ems-esp/api/thermostat/minexttemp) | Min. outdoor temperature | thermostat | 🔢 | °C | ✔ | [Design outdoor temperature](/en/docs/einstellungen/#normaußentemperatur) |
| [summertemp](http://ems-esp/api/thermostat/summertemp) | HC1 summer temperature | thermostat<br>hc1 | 🔢 | °C | ✔ | [Heating limit](/en/docs/einstellungen/#heizgrenze) |
| [tempdiffheat](http://ems-esp/api/boiler/tempdiffheat) | Temp. diff. TC3/TC0 heating | boiler | 🔢 | K | ✔ | Target temperature difference between flow and return of the primary circuit during heating |
| [tempdiffcool](http://ems-esp/api/boiler/tempdiffcool) | Temp. diff. TC3/TC0 cooling | boiler | 🔢 | K | ✔ | Target temperature difference between flow and return of the primary circuit during cooling |
| [seltemp](http://ems-esp/api/thermostat/seltemp) | HC1 selected [room temperature](/en/docs/einstellungen/#raumtemperatur) | thermostat<br>hc1 | 🔢 | °C | ✔ | Desired [room temperature](/en/docs/einstellungen/#raumtemperatur) |
...
| [intoffset](http://ems-esp/api/thermostat/intoffset) | Internal temperature correction | thermostat | 🔢 | °C | ✔ | [Room temperature offset](/en/docs/einstellungen/#raumtemperatur) by which _seltemp_ should be corrected |
...
| [curtemp2](http://ems-esp/api/boiler/curtemp2) | DHW current external temperature | boiler<br>dhw | 🔢 | °C | | Currently measured domestic hot water temperature in the hot water tank - identical to _hptw1_ |
| [hptw1](http://ems-esp/api/boiler/hptw1) | DHW reservoir (TW1) | boiler | 🔢 | °C | | Currently measured domestic hot water temperature in the hot water tank (lower measuring point) - identical to _curtemp2_ |
| [curtemp](http://ems-esp/api/boiler/curtemp) | DHW current internal temperature | boiler<br>dhw | 🔢 | °C | | Currently measured domestic hot water temperature in the hot water tank (upper optional measuring point), if installed; otherwise identical to _hptw1_ |

#### Settings

See also [domestic hot water settings](/en/docs/einstellungen/#warmwasserbereitung).
The entities for the difference and stop temperatures are only available for the Bosch CS5800/6800i and Buderus WLW176/186i.

| ID | Name | Module | Type | Unit | RW | Description |
| -- | -- | -- | -- | -- | -- | -- |
| [comfdiff](http://ems-esp/api/boiler/comfdiff) | DHW comfort difference temp. | boiler<br>dhw | 🔢 | K | ✔ | [Charging delta](/en/docs/einstellungen/#warmwasserbereitung) in Comfort mode, by which the flow temperature is increased |
| [ecodiff](http://ems-esp/api/boiler/ecodiff) | DHW ECO difference temp. | boiler<br>dhw | 🔢 | K | ✔ | [Charging delta](/en/docs/einstellungen/#warmwasserbereitung) in Eco mode, by which the flow temperature is increased |
| [ecoplusdiff](http://ems-esp/api/boiler/ecoplusdiff) | DHW ECO+ difference temp. | boiler<br>dhw | 🔢 | K | ✔ | [Charging delta](/en/docs/einstellungen/#warmwasserbereitung) in Eco+ mode, by which the flow temperature is increased |
| [comfstop](http://ems-esp/api/boiler/comfstop) | DHW comfort stop temp. | boiler<br>dhw | 🔢 | °C | ✔ | [Stop temperature](/en/docs/einstellungen/#warmwasserbereitung) in Comfort mode, at which domestic hot water production ends |
| [ecostop](http://ems-esp/api/boiler/ecostop) | DHW ECO stop temp. | boiler<br>dhw | 🔢 | °C | ✔ | [Stop temperature](/en/docs/einstellungen/#warmwasserbereitung) in Eco mode, at which domestic hot water production ends |
| [ecoplusstop](http://ems-esp/api/boiler/ecoplusstop) | DHW ECO+ stop temp. | boiler<br>dhw | 🔢 | °C | ✔ | [Stop temperature](/en/docs/einstellungen/#warmwasserbereitung) in Eco+ mode, at which domestic hot water production ends |
| [seltempsingle](http://ems-esp/api/boiler/seltempsingle) | DHW one-time charging temperature | boiler<br>dhw | 🔢 | °C | ✔ | [Stop temperature](/en/docs/einstellungen/#warmwasserbereitung) for Extra DHW |
| [disinfectiontemp](http://ems-esp/api/boiler/disinfectiontemp) | DHW disinfection temperature | boiler<br>dhw | 🔢 | °C | ✔ | [Stop temperature](/en/docs/einstellungen/#warmwasserbereitung) for domestic hot water disinfection |
| [seltemp](http://ems-esp/api/boiler/seltemp) | DHW selected temperature | boiler<br>dhw | 🔢 | °C | ✔ | [Start temperature](/en/docs/einstellungen/#warmwasserbereitung) in Comfort mode, at which domestic hot water production begins |
| [seltemplow](http://ems-esp/api/boiler/seltemplow) | DHW selected lower temperature | boiler<br>dhw | 🔢 | °C | ✔ | [Start temperature](/en/docs/einstellungen/#warmwasserbereitung) in Eco mode, at which domestic hot water production begins |
| [tempecoplus](http://ems-esp/api/boiler/tempecoplus) | DHW selected ECO+ temperature | boiler<br>dhw | 🔢 | °C | ✔ | [Start temperature](/en/docs/einstellungen/#warmwasserbereitung) in Eco+ mode, at which domestic hot water production begins |

WLW 196i provides stop temperatures under the following entities:

| ID | Name | Module | Type | Unit | RW | Description |
| -- | -- | -- | -- | -- | -- | -- |
| [comfoff](http://ems-esp/api/boiler/comfoff) | DHW comfort switch-off temp. | boiler<br>dhw | 🔢 | °C | ✔ | [Stop temperature](/en/docs/einstellungen/#warmwasserbereitung) in Comfort mode, at which domestic hot water production ends<br>WLW196i only |
| [ecooff](http://ems-esp/api/boiler/ecooff) | DHW ECO switch-off temp. | boiler<br>dhw | 🔢 | °C | ✔ | [Stop temperature](/en/docs/einstellungen/#warmwasserbereitung) in Eco mode, at which domestic hot water production ends<br>WLW196i only |
| [ecoplusoff](http://ems-esp/api/boiler/ecoplusoff) | DHW ECO+ switch-off temp. | boiler<br>dhw | 🔢 | °C | ✔ | [Stop temperature](/en/docs/einstellungen/#warmwasserbereitung) in Eco+ mode, at which domestic hot water production ends<br>WLW196i only |
...
| [heatingpumpmod](http://ems-esp/api/boiler/heatingpumpmod) | Heating pump modulation | boiler | 🔢 | % | | Percentage output of the primary circuit pump PC0 |
| [pc0flow](http://ems-esp/api/boiler/pc0flow) | PC0 flow | boiler | 🔢 | l/h | | Flow rate of the primary circuit pump PC0 (unfortunately no value at lower output) |
| [pc1flow](http://ems-esp/api/boiler/pc1flow) | PC1 flow | boiler | 🔢 | l/h | | Flow rate of the heating circuit pump PC1 |
...
| [circpump](http://ems-esp/api/boiler/circpump) | DHW circulation pump present | boiler<br>dhw | ☑ | | ✔ | ON when the DHW circulation pump should be controlled by the system |
...
| [curburnpow](http://ems-esp/api/boiler/curburnpow) | Current burner output | boiler | 🔢 | % | | Current modulation (relative output) of the compressor - identical to _hpcompspd_ |
| [hpcompspd](http://ems-esp/api/boiler/hpcompspd) | Compressor speed | boiler | 🔢 | % | | Current modulation (relative output) of the compressor |
...
| [syspress](http://ems-esp/api/boiler/syspress) | System pressure | boiler | 🔢 | bar | | Water pressure in the heating circuit<br>CS5800/6800i & WLW176/186i only |
...
| [auxheaterlevel](http://ems-esp/api/boiler/auxheaterlevel) | Auxiliary heater | boiler | 🔢 | % | | Current relative output of the auxiliary heater |
| [hpoperatingstate](http://ems-esp/api/thermostat/hpoperatingstate) | HC1 heat pump operating state | thermostat<br>hc1 | enum | | | Selected operating state (e.g. by automatic summer/winter changeover): "heating"\|"off"\|"cooling" |
...
| [altopprioheat](http://ems-esp/api/boiler/altopprioheat) | DHW heating preferred over DHW | boiler<br>dhw | 🔢 | minutes | ✔ | Maximum duration in domestic hot water operation until switching to heating operation |
| [altopprio](http://ems-esp/api/boiler/altopprio) | DHW preferred over heating | boiler<br>dhw | 🔢 | minutes | ✔ | Maximum duration in heating operation until switching to domestic hot water operation |
...
| [damping](http://ems-esp/api/thermostat/damping) | Outdoor temperature damping | thermostat | ☑ | | ✔ | ON when the outdoor temperature should be [damped](/en/docs/einstellungen/#d%C3%A4mpfung-der-au%C3%9Fentemperatur) - inertia adjustable via _building_ |
| [building](http://ems-esp/api/thermostat/building) | Building type | thermostat | enum | | ✔ | Strength of [outdoor temperature damping](/en/docs/einstellungen/#d%C3%A4mpfung-der-au%C3%9Fentemperatur): ["Light"\| "Medium"\|"Heavy"] - (de)activation via _damping_ |
| [mode](http://ems-esp/api/thermostat/mode) | HC1 operating mode | thermostat<br>hc1 | enum | | ✔ | [Room temperature mode](/en/docs/einstellungen/#raumtemperatur): ["off"\|"Manual"\|"auto"] |
...
| [heatondelay](http://ems-esp/api/thermostat/heatondelay) | HC1 heating switch-on delay | thermostat<br>hc1 | 🔢 | hours | ✔ | [Heating operation delay](/en/docs/einstellungen/#heizgrenze) of the automatic summer/winter changeover |
| [heatoffdelay](http://ems-esp/api/thermostat/heatoffdelay) | HC1 heating switch-off delay | thermostat<br>hc1 | 🔢 | hours | ✔ | [Summer operation delay](/en/docs/einstellungen/#heizgrenze) of the automatic summer/winter changeover |
| [instantstart](http://ems-esp/api/thermostat/instantstart) | HC1 immediate start | thermostat<br>hc1 | 🔢 | K | ✔ | [Temperature difference for immediate start](/en/docs/einstellungen/#heizgrenze) of the automatic summer/winter changeover |

### Photovoltaics

| ID | Name | Module | Type | Unit | RW | Description |
| -- | -- | -- | -- | -- | -- | -- |
| [pvraiseheat](http://ems-esp/api/thermostat/pvraiseheat) | Increase heating with PV | thermostat | 🔢 | K | ✔ | Increase in [room temperature](/en/docs/einstellungen/#raumtemperatur) with PV surplus |
| [pvlowercool](http://ems-esp/api/thermostat/pvlowercool) | Lower cooling with PV | thermostat | 🔢 | K | ✔ | Reduction in [room temperature](/en/docs/einstellungen/#raumtemperatur) with PV surplus |
| [pvmaxcomp](http://ems-esp/api/boiler/pvmaxcomp) | PV max. compressor power | boiler | 🔢 | kW | ✔ | Maximum compressor power with PV surplus |
...
| [pvenabledhw](http://ems-esp/api/thermostat/pvenabledhw) | Enable DHW increase | thermostat | ☑ | | ✔ | Increase in DHW temperature with PV surplus |

### Electric auxiliary heater

| ID | Name | Module | Type | Unit | RW | Description |
| -- | -- | -- | -- | -- | -- | -- |
| [maxheatcomp](http://ems-esp/api/boiler/maxheatcomp) | Electric backup heater limit with compressor | boiler | enum | | ✔ | [Maximum output of the auxiliary heater with compressor](/en/docs/einstellungen/#begrenzung-mit-kompressor) [0kW\|3kW\|6kW\|9kW] |
| [maxheatheat](http://ems-esp/api/boiler/maxheatheat) | Electric backup heater output limit | boiler | enum | | ✔ | [Maximum output of the auxiliary heater without compressor](/en/docs/einstellungen/#begrenzung-ohne-kompressor) [0kW\|3kW\|6kW\|9kW] |
| [maxheat](http://ems-esp/api/boiler/maxheat) | DHW electric backup heater limit | boiler<br>dhw | enum | | ✔ | [Maximum output of the auxiliary heater in domestic hot water operation](https://bosch-buderus-wp.github.io/en/docs/einstellungen/#begrenzung-im-ww-betrieb) [0kW\|3kW\|6kW\|9kW] |
...
| [auxheateronly](http://ems-esp/api/boiler/auxheateronly) | Auxiliary heater only | boiler | ☑ | | ✔ | ON when heating and domestic hot water operation take place exclusively via the auxiliary heater |
| [auxheateroff](http://ems-esp/api/boiler/auxheateroff) | Disable auxiliary heater | boiler | ☑ | | ✔ | ON when the [auxiliary heater is disabled](/en/docs/einstellungen/#zuheizersperre) |
| [auxheaterdelay](http://ems-esp/api/boiler/auxheaterdelay) | Auxiliary heater delayed on | boiler | 🔢 | K\*min | ✔ | [Delay](/en/docs/einstellungen/#verz%C3%B6gerung-heizung) as the product of undershooting the target temperature and duration until the auxiliary heater is switched on |
| [auxmaxlimit](http://ems-esp/api/boiler/auxmaxlimit) | Auxiliary heater max. limit | boiler | 🔢 | K | ✔ | Temperature difference below the maximum flow temperature at which the auxiliary heater is blocked |
| [tempparmode](http://ems-esp/api/boiler/tempparmode) | Electric backup heater parallel operation | boiler | 🔢 | °C | ✔ | [Bivalent point](/en/docs/einstellungen/#bivalpkt-parallelbetr), from which the auxiliary heater is switched on/off |
...
| [mintempsilent](http://ems-esp/api/boiler/mintempsilent) | Minimum outdoor temperature silent mode | boiler | 🔢 | °C | ✔ | Minimum temperature from which silent mode is switched off in the Auto setting |
...
| ID | Name | Module | Type | Unit | RW | Description |
| -- | -- | -- | -- | -- | -- | -- |
| [ubauptime](http://ems-esp/api/boiler/ubauptime) | Total system runtime | boiler | 🔢 | minutes | | ??? |
| [uptimetotal](http://ems-esp/api/boiler/uptimetotal) | Total heat pump operating time | boiler | 🔢 | minutes | | Total system runtime, including standby |
| [uptimecontrol](http://ems-esp/api/boiler/uptimecontrol) | Total heating operating time | boiler | 🔢 | minutes | | Total system operating time in **heating, cooling or domestic hot water operation** (without standby) |
| [uptimecompheating](http://ems-esp/api/boiler/uptimecompheating) | Compressor operating time heating | boiler | 🔢 | minutes | | Total system operating time in **heating operation** (without standby) |
| [uptimecompcooling](http://ems-esp/api/boiler/uptimecompcooling) | Compressor operating time cooling | boiler | 🔢 | minutes | | Total system operating time in **cooling operation** (without standby) |
| [uptimecomp](http://ems-esp/api/boiler/uptimecomp) | DHW compressor operating time | boiler<br>dhw | 🔢 | minutes | | Total system operating time in **domestic hot water operation** (without standby) |
| [uptimecomppool](http://ems-esp/api/boiler/uptimecomppool) | Compressor operating time pool | boiler | 🔢 | minutes | | -- presumably not relevant -- |
...
| [poolstarts](http://ems-esp/api/boiler/poolstarts) | Pool control starts | boiler | 🔢 | | | -- presumably not relevant -- |
...
| [mandefrost](http://ems-esp/api/boiler/mandefrost) | Manual defrost | boiler | ☑ | | ✔ | Defrost cycle is started |
...
| [pumpmodmax](http://ems-esp/api/boiler/pumpmodmax) | Maximum boiler pump output | boiler | 🔢 | % | ✔ | Always 0 |
| [pumpmodmin](http://ems-esp/api/boiler/pumpmodmin) | Minimum boiler pump output | boiler | 🔢 | % | ✔ | Always 0 |
| [pumpcharacter](http://ems-esp/api/boiler/pumpcharacter) | Boiler pump characteristic | boiler | enum | | ✔ | --- |
| [pumpdelay](http://ems-esp/api/boiler/pumpdelay) | Pump overrun time | boiler | 🔢 | minutes | ✔ | --- |
| [pumpontemp](http://ems-esp/api/boiler/pumpontemp) | Pump logic temperature | boiler | 🔢 | °C | ✔ | --- |
| [switchtemp](http://ems-esp/api/boiler/switchtemp) | Mixing valve switching temperature | boiler | 🔢 | °C | | |
| [selburnpow](http://ems-esp/api/boiler/selburnpow) | Set maximum burner output | boiler | 🔢 | % | ✔ | Always 0 |
| [burnstarts](http://ems-esp/api/boiler/burnstarts) | Burner starts | boiler | 🔢 | | | Always 0 |
| [burnworkmin](http://ems-esp/api/boiler/burnworkmin) | Burner runtime | boiler | 🔢 | minutes | | Always 0 |
| [burn2workmin](http://ems-esp/api/boiler/burn2workmin) | Burner runtime stage 2 | boiler | 🔢 | minutes | | Always 0 |
| [heatworkmin](http://ems-esp/api/boiler/heatworkmin) | Heating runtime | boiler | 🔢 | minutes | | Always 0 |
...
| [hpmaxpower](http://ems-esp/api/boiler/hpmaxpower) | Max. compressor output | boiler | 🔢 | % | ✔ | --- |
...
| [poolsettemp](http://ems-esp/api/boiler/poolsettemp) | Pool temperature target | boiler | 🔢 | °C | ✔ | |
| [auxlimitstart](http://ems-esp/api/boiler/auxlimitstart) | Auxiliary heater start limit | boiler | 🔢 | K | ✔ | |
...
| [maxpower](http://ems-esp/api/boiler/maxpower) | DHW max. output | boiler<br>dhw | 🔢 | % | ✔ | --- |
...
| [mixertemp](http://ems-esp/api/boiler/mixertemp) | DHW mixing temperature | boiler<br>dhw | 🔢 | °C | | --- |
...
| [reducemode](http://ems-esp/api/thermostat/reducemode) | HC1 reduced mode | thermostat<br>hc1 | enum | | ✔ | |
| [noreducetemp](http://ems-esp/api/thermostat/noreducetemp) | HC1 continuous heating below | thermostat<br>hc1 | 🔢 | °C | ✔ | |
| [reducetemp](http://ems-esp/api/thermostat/reducetemp) | HC1 reduced mode below | thermostat<br>hc1 | 🔢 | °C | ✔ | |
...
| [coolstart](http://ems-esp/api/thermostat/coolstart) | HC1 cooling operation from | thermostat<br>hc1 | 🔢 | °C | ✔ | |
...
The complete list of entities can be read from ems-esp by opening the following URL: [http://ems-esp/api/boiler/entities](http://ems-esp/api/boiler/entities) or [http://ems-esp/api/thermostat/entities](http://ems-esp/api/thermostat/entities).
You can also have them generated directly as a Markdown table using `curl` and `jq`:
...
To do so, simply open [http://homeassistant.local:8123/developer-tools/template](http://homeassistant.local:8123/developer-tools/template) and replace the contents of the template editor with the following expression:
...
In Home Assistant, `dhw` is replaced by `ww`.
