...
Some entities are only available for Bosch CS5800/6800i and Buderus WLW176/186i.
...
The following entities are only available for Bosch CS5800/6800i and Buderus WLW176/186i.
...
| [metertotal](http://ems-esp/api/boiler/metertotal) | Total metering    | boiler        | 🔢  | kWh     |     | Total **used** electrical energy of the **heat pump and auxiliary heater** for **heating, cooling and domestic hot water** - more precise version of _nrgconstotal_ |
| [metercomp](http://ems-esp/api/boiler/metercomp)   | Compressor metering | boiler       | 🔢  | kWh     |     | Total **used** electrical energy of the **heat pump** for **heating, cooling and domestic hot water** - more precise version of _nrgconscomptotal_                 |
| [metereheat](http://ems-esp/api/boiler/metereheat) | Electric heater metering | boiler    | 🔢  | kWh     |     | Total **used** electrical energy of the **auxiliary heater** - more precise version of _auxelecheatnrgconstotal_                                                     |
| [meterheat](http://ems-esp/api/boiler/meterheat)   | Heating metering  | boiler        | 🔢  | kWh     |     | Total **used** electrical energy for **heating**                                                                                                                    |
| [meter](http://ems-esp/api/boiler/meter)           | DHW metering      | boiler<br>dhw | 🔢  | kWh     |     | Total **used** electrical energy for **domestic hot water**                                                                                                         |
| [metercool](http://ems-esp/api/boiler/metercool)   | Cooling metering  | boiler        | 🔢  | kWh     |     | Total **used** electrical energy for **cooling**                                                                                                                    |

### Without Decimal Places

_"nrgsupp..."_: generated thermal energy (heat)\
_"nrgcons..."_: used electrical energy (electricity consumption)\
_"nrgconscomp..."_: used electrical energy of the heat pump\
_"auxelecheatnrgcons..."_: used electrical energy of the electric auxiliary heater
...
| [nrgsupp](http://ems-esp/api/boiler/nrgsupp)                                     | DHW total energy output heat              | boiler<br>dhw | 🔢  | kWh     |     | Total **generated** thermal energy for **domestic hot water**                                                         |
...
| [nrgconstotal](http://ems-esp/api/boiler/nrgconstotal)                           | Total energy consumption                 | boiler        | 🔢  | kWh     |     | Total **used** electrical energy of the **heat pump and auxiliary heater** for **heating, cooling and domestic hot water** |
| [nrgconscomptotal](http://ems-esp/api/boiler/nrgconscomptotal)                   | Total energy consumption compressor      | boiler        | 🔢  | kWh     |     | Total **used** electrical energy of the **heat pump** for **heating, cooling and domestic hot water**              |
| [nrgconscompheating](http://ems-esp/api/boiler/nrgconscompheating)               | Energy consumption compressor heating    | boiler        | 🔢  | kWh     |     | Total **used** electrical energy of the **heat pump** for **heating**                                      |
| [nrgconscomp](http://ems-esp/api/boiler/nrgconscomp)                             | DHW energy consumption compressor        | boiler<br>dhw | 🔢  | kWh     |     | Total **used** electrical energy of the **heat pump** for **domestic hot water**                                   |
| [nrgconscompcooling](http://ems-esp/api/boiler/nrgconscompcooling)               | Energy consumption compressor cooling    | boiler        | 🔢  | kWh     |     | Total **used** electrical energy of the **heat pump** for **cooling**                                      |
...
| [auxelecheatnrgconstotal](http://ems-esp/api/boiler/auxelecheatnrgconstotal)     | Energy consumption electric auxiliary heating | boiler    | 🔢  | kWh     |     | Total **used** electrical energy of the **auxiliary heater** for **heating and domestic hot water**                        |
| [auxelecheatnrgconsheating](http://ems-esp/api/boiler/auxelecheatnrgconsheating) | Energy consumption electric auxiliary heating | boiler | 🔢  | kWh     |     | Total **used** electrical energy of the **auxiliary heater** for **heating**                                       |
| [auxelecheatnrgcons](http://ems-esp/api/boiler/auxelecheatnrgcons)               | DHW energy consumption electric auxiliary heating | boiler<br>dhw | 🔢  | kWh |     | Total **used** electrical energy of the **auxiliary heater** for **domestic hot water** |
...
| ID                                                                   | Name                               | Module            | Type | Unit | RW  | Description                                                                                                            |
| -------------------------------------------------------------------- | ---------------------------------- | ----------------- | ---- | ---- | --- | ----------------------------------------------------------------------------------------------------------------------- |
| [outdoortemp](http://ems-esp/api/boiler/outdoortemp)                 | Outdoor temperature                | boiler            | 🔢  | °C   |     | Outdoor temperature measured by the outdoor thermometer                                                                  |
...
| [curflowtemp](http://ems-esp/api/boiler/curflowtemp)                 | Current flow temperature           | boiler            | 🔢  | °C   |     | Flow temperature after the buffer tank (T0)                                                                              |
...
| [hpta4](http://ems-esp/api/boiler/hpta4)                             | Condensate pan (TA4)               | boiler            | 🔢  | °C   |     | Temperature at the condensate pan                                                                                        |
...
| ID                                                       | Name                                                               | Module            | Type | Unit | RW  | Description                                                                                          |
| -------------------------------------------------------- | ------------------------------------------------------------------ | ----------------- | ---- | ---- | --- | ----------------------------------------------------------------------------------------------------- |
| [selflowtemp](http://ems-esp/api/boiler/selflowtemp)     | Selected flow temperature                                         | boiler            | 🔢  | °C   | ✔   | Target flow temperature without increase by the energy manager/PV                                           |
...
| [offsettemp](http://ems-esp/api/thermostat/offsettemp)   | HC1 temperature increase                                           | thermostat<br>hc1 | 🔢  | °C   | ✔   | Value by which the flow temperature in HC1 is to be manually increased                               |
...
| [minexttemp](http://ems-esp/api/thermostat/minexttemp)   | Min. outdoor temperature                                           | thermostat        | 🔢  | °C   | ✔   | [Standard outdoor temperature](/en/docs/einstellungen/#normaußentemperatur)                                       |
...
| [tempdiffheat](http://ems-esp/api/boiler/tempdiffheat)   | Temp. diff. TC3/TC0 heating                                          | boiler            | 🔢  | K    | ✔   | Target temperature difference between the flow and return of the primary circuit during heating                           |
| [tempdiffcool](http://ems-esp/api/boiler/tempdiffcool)   | Temp. diff. TC3/TC0 cooling                                          | boiler            | 🔢  | K    | ✔   | Target temperature difference between the flow and return of the primary circuit during cooling                           |
...
| [intoffset](http://ems-esp/api/thermostat/intoffset)     | Internal temperature correction                                      | thermostat        | 🔢  | °C   | ✔   | [Room temperature offset](/en/docs/einstellungen/#raumtemperatur) by which _seltemp_ is to be corrected |
...
The entities for the difference and stop temperatures are only available for Bosch CS5800/6800i and Buderus WLW176/186i.

| ID                                                             | Name                              | Module        | Type | Unit | RW  | Description                                                                                                               |
| -------------------------------------------------------------- | --------------------------------- | ------------- | ---- | ---- | --- | -------------------------------------------------------------------------------------------------------------------------- |
| [comfdiff](http://ems-esp/api/boiler/comfdiff)                 | DHW comfort temperature difference | boiler<br>dhw | 🔢 | K | ✔ | [Charging delta](/en/docs/einstellungen/#warmwasserbereitung) in Comfort mode, by which the flow temperature is increased       |
| [ecodiff](http://ems-esp/api/boiler/ecodiff)                   | DHW ECO temperature difference | boiler<br>dhw | 🔢 | K | ✔ | [Charging delta](/en/docs/einstellungen/#warmwasserbereitung) in Eco mode, by which the flow temperature is increased           |
| [ecoplusdiff](http://ems-esp/api/boiler/ecoplusdiff)           | DHW ECO+ temperature difference | boiler<br>dhw | 🔢 | K | ✔ | [Charging delta](/en/docs/einstellungen/#warmwasserbereitung) in Eco+ mode, by which the flow temperature is increased          |
| [comfstop](http://ems-esp/api/boiler/comfstop)                 | DHW comfort stop temperature | boiler<br>dhw | 🔢 | °C | ✔ | [Stop temperature](/en/docs/einstellungen/#warmwasserbereitung) in Comfort mode, at which domestic hot water production ends |
| [ecostop](http://ems-esp/api/boiler/ecostop)                   | DHW ECO stop temperature | boiler<br>dhw | 🔢 | °C | ✔ | [Stop temperature](/en/docs/einstellungen/#warmwasserbereitung) in Eco mode, at which domestic hot water production ends |
| [ecoplusstop](http://ems-esp/api/boiler/ecoplusstop)           | DHW ECO+ stop temperature | boiler<br>dhw | 🔢 | °C | ✔ | [Stop temperature](/en/docs/einstellungen/#warmwasserbereitung) in Eco+ mode, at which domestic hot water production ends |
...
| ID                                                 | Name                       | Module        | Type | Unit | RW  | Description                                                                                                                             |
| -------------------------------------------------- | -------------------------- | ------------- | ---- | ---- | --- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| [comfoff](http://ems-esp/api/boiler/comfoff)       | DHW comfort switch-off temperature | boiler<br>dhw | 🔢 | °C | ✔ | [Stop temperature](/en/docs/einstellungen/#warmwasserbereitung) in Comfort mode, at which domestic hot water production ends<br>WLW196i only |
| [ecooff](http://ems-esp/api/boiler/ecooff)         | DHW ECO switch-off temperature | boiler<br>dhw | 🔢 | °C | ✔ | [Stop temperature](/en/docs/einstellungen/#warmwasserbereitung) in Eco mode, at which domestic hot water production ends<br>WLW196i only |
| [ecoplusoff](http://ems-esp/api/boiler/ecoplusoff) | DHW ECO+ switch-off temperature | boiler<br>dhw | 🔢 | °C | ✔ | [Stop temperature](/en/docs/einstellungen/#warmwasserbereitung) in Eco+ mode, at which domestic hot water production ends<br>WLW196i only |

## Pumps

The entities for PC0 and PC1 are only available for Bosch CS5800/6800i and Buderus WLW176/186i.
...
| [curburnpow](http://ems-esp/api/boiler/curburnpow)                 | Current burner power        | boiler            | 🔢   | %    |     | Current modulation (relative output) of the compressor - identical to _hpcompspd_                            |
...
| [hpactivity](http://ems-esp/api/boiler/hpactivity)                 | Compressor activity          | boiler            | enum |      |     | Current compressor activity: "none", "heating", "cooling", "domestic hot water", "pool", "unknown", "defrost cycle" |
| [hp4way](http://ems-esp/api/boiler/hp4way)                         | 4-way valve (VR4)          | boiler            | enum |      |     | Current position of the 4-way valve in the refrigerant circuit: "cooling & defrost cycle" or "heating & domestic hot water"             |
| [hpea0](http://ems-esp/api/boiler/hpea0)                           | Heating condensate pan (EA0) | boiler            | ☑    |      |     | ON when the condensate pan heater is currently active                                                           |
...
| [hpoperatingstate](http://ems-esp/api/thermostat/hpoperatingstate) | HC1 heat pump operating state | thermostat<br>hc1 | enum |      |     | Selected operating state (e.g. via automatic summer/winter changeover): "heating"\|"off"\|"cooling"           |

## Settings

| ID                                                             | Name                            | Module            | Type | Unit | RW  | Description                                                                                                                                                         |
| -------------------------------------------------------------- | ------------------------------- | ----------------- | ---- | ---- | --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [heatingactivated](http://ems-esp/api/boiler/heatingactivated) | Heating operation activated     | boiler            | ☑    |      | ✔   | ON when the system is to be used for heating operation                                                                                                           |
| [activated](http://ems-esp/api/boiler/activated)               | DHW activated                  | boiler<br>dhw     | ☑    |      | ✔   | ON when the system is to be used for domestic hot water production                                                                                                       |
...
| [damping](http://ems-esp/api/thermostat/damping)               | Outdoor temperature damping   | thermostat        | ☑    |      | ✔   | ON when the outdoor temperature is to be [damped](/en/docs/einstellungen/#d%C3%A4mpfung-der-au%C3%9Fentemperatur) - inertia adjustable via _building_                   |
| [building](http://ems-esp/api/thermostat/building)             | Building type                 | thermostat        | enum |      | ✔   | Strength of [outdoor temperature damping](/en/docs/einstellungen/#d%C3%A4mpfung-der-au%C3%9Fentemperatur): ["light"\| "medium"\|"heavy"] - activation/deactivation via _damping_ |
...
| ID                                                       | Name                       | Module     | Type | Unit | RW  | Description                                                                          |
| -------------------------------------------------------- | -------------------------- | ---------- | ---- | ---- | --- | ------------------------------------------------------------------------------------- |
| [pvraiseheat](http://ems-esp/api/thermostat/pvraiseheat) | Increase heating with PV   | thermostat | 🔢 | K | ✔ | Increase of the [room temperature](/en/docs/einstellungen/#raumtemperatur) with PV surplus |
| [pvlowercool](http://ems-esp/api/thermostat/pvlowercool) | Decrease cooling with PV  | thermostat | 🔢 | K | ✔ | Decrease of the [room temperature](/en/docs/einstellungen/#raumtemperatur) with PV surplus |
...
| [pvenabledhw](http://ems-esp/api/thermostat/pvenabledhw) | Activate DHW increase     | thermostat | ☑ | | ✔ | Increase of the DHW temperature with PV surplus |

### Electric Auxiliary Heater

| ID                                                         | Name                          | Module        | Type | Unit | RW  | Description                                                                                                                                                  |
| ---------------------------------------------------------- | ----------------------------- | ------------- | ---- | ---- | --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [maxheatcomp](http://ems-esp/api/boiler/maxheatcomp)       | Electric backup heater limit with compressor | boiler | enum | | ✔ | [Max. output of the auxiliary heater with compressor](/en/docs/einstellungen/#begrenzung-mit-kompressor) [0kW\|3kW\|6kW\|9kW] |
| [maxheatheat](http://ems-esp/api/boiler/maxheatheat)       | Electric backup heater output limit | boiler | enum | | ✔ | [Max. output of the auxiliary heater without compressor](/en/docs/einstellungen/#begrenzung-ohne-kompressor) [0kW\|3kW\|6kW\|9kW] |
| [maxheat](http://ems-esp/api/boiler/maxheat)               | DHW electric backup heater limit for DHW | boiler<br>dhw | enum | | ✔ | [Max. output of the auxiliary heater during domestic hot water operation](https://bosch-buderus-wp.github.io/en/docs/einstellungen/#begrenzung-im-ww-betrieb) [0kW\|3kW\|6kW\|9kW] |
...
| [auxheaterdelay](http://ems-esp/api/boiler/auxheaterdelay) | Auxiliary heater delayed on | boiler        | 🔢   | K\*min | ✔ | [Delay](/en/docs/einstellungen/#verz%C3%B6gerung-heizung) as the product of the target temperature undershoot and duration until the auxiliary heater is switched on |
...
| [mintempsilent](http://ems-esp/api/boiler/mintempsilent) | Minimum outdoor temperature silent mode | boiler | 🔢 | °C | ✔ | Min. temperature from which silent mode is switched off in the Auto setting |
...
| [uptimecontrol](http://ems-esp/api/boiler/uptimecontrol)         | Total heating operating time   | boiler        | 🔢  | minutes | | Total system operating time in **heating, cooling or domestic hot water operation** (excluding standby) |
| [uptimecompheating](http://ems-esp/api/boiler/uptimecompheating) | Compressor operating time heating | boiler | 🔢 | minutes | | Total system operating time in **heating operation** (excluding standby) |
| [uptimecompcooling](http://ems-esp/api/boiler/uptimecompcooling) | Compressor operating time cooling | boiler | 🔢 | minutes | | Total system operating time in **cooling operation** (excluding standby) |
| [uptimecomp](http://ems-esp/api/boiler/uptimecomp)               | DHW compressor operating time | boiler<br>dhw | 🔢 | minutes | | Total system operating time in **domestic hot water operation** (excluding standby) |
...
| OFF     | ON      | Increased operation |
| ON      | ON      | Forced increased operation |
...
| [heatingoff](http://ems-esp/api/boiler/heatingoff)     | Switch off heating | boiler | ☑ | | ✔ | ? |
...
| [poolsettemp](http://ems-esp/api/boiler/poolsettemp)               | Pool temperature target value | boiler | 🔢 | °C | ✔ | |
...
| [cylmiddletemp](http://ems-esp/api/boiler/cylmiddletemp)           | DHW tank temperature middle | boiler<br>dhw | 🔢 | °C | | --- |
...
| [floordry](http://ems-esp/api/thermostat/floordry)                         | Floor drying | thermostat | enum | | | |
| [floordrytemp](http://ems-esp/api/thermostat/floordrytemp)                 | Floor drying temperature | thermostat | 🔢 | °C | | |
...
| [remotetemp](http://ems-esp/api/thermostat/remotetemp)                     | HC1 room temperature remote | thermostat<br>hc1 | 🔢 | °C | ✔ | |
| [remotehum](http://ems-esp/api/thermostat/remotehum)                       | HC1 room humidity remote | thermostat<br>hc1 | 🔢 | % | ✔ | |
