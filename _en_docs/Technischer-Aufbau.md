---
title: "Technical design of refrigerant circuit, primary circuit and heating circuit"
...
The heart of the system is the so-called refrigerant cycle, in which a refrigerant circulates and absorbs and releases heat.
In the **evaporator**, heat from the ambient air is absorbed by the cold refrigerant.
In the **compressor**, the refrigerant is compressed and thereby heated—just as a bicycle pump heats up when pumping.
In the **condenser**, the heat is transferred to the water in the heating system, causing it to cool down.
...
This means that at typical temperatures in the German winter, the refrigerant in the evaporator absorbs heat from the warmer ambient air and becomes gaseous.
...
- the primary circuit has a lower flow rate than the heating circuit draws—in this case, the heating circuit transports colder water from its return directly back into its flow.
...
If the heat pump is also used to heat domestic hot water, the 3-way valve ensures that, at certain times, the domestic hot water tank is circulated instead of the heating circuit (see also [Domestic hot water production](/docs/einstellungen#warmwasserbereitung)).

## Modulation

Reaching or maintaining the target flow temperature sometimes requires more and sometimes less power.
At low outdoor temperatures, more than one kilowatt of electrical energy must be used, for example, to raise the flow temperature from −5 °C outdoor temperature to 37 °C.
...
If the flow temperature cooled down again shortly afterwards, it would have to start up briefly again, only to switch off again shortly afterwards.
This constant switching on and off is called **cycling** and reduces efficiency while increasing wear.

To counteract cycling, the Bosch/Buderus heat pump has what is known as inverter control, which can adjust the compressor speed to the demand within certain limits.
If less heat is required, the inverter control reduces the speed, generating less heat and thus preventing cycling.
However, inverter control cannot modulate down indefinitely; eventually, the lower limit is reached and the heat pump must cycle.
In addition, heat pumps often operate less efficiently at the lower and upper limits.

## Defrost cycle

At high humidity and temperatures below approximately 7 °C, ice forms on the evaporator at the rear of the outdoor unit.
The ice obstructs the airflow and thereby impairs efficiency.
...
This produces a great deal of water, which drains through the condensate tray.
For proper drainage, it is important that the condensate drain is dimensioned sufficiently large and remains free of ice.
The condensate tray heater or the associated heating cable is activated as required to prevent ice formation.
...
At approximately 9–16 minutes, these hot-gas defrost cycles last significantly longer.
...
During defrosting, generated heat energy is used to de-ice the evaporator in the outdoor unit and is therefore 'lost'. Consequently, the COP is negative during this time.

## Energy monitoring and electricity consumption

For evaluation, the **system boundary** is important first: In Bosch/Buderus systems, electricity consumption includes not only the compressor and fan but also the electronics and control system, crankcase heater, standby consumption and electric backup heater.
...
As a result, Bosch/Buderus systems may show a lower performance factor on the display even though they are not technically less efficient.
...
If one of the _PC0_ or _PC1_ pumps (Grundfos UPM4L (K) LIN) is also running, approximately 10–75 W is added per pump, depending on the speed.

The **crankcase heater**, also known as the compressor or oil sump heater, keeps the switched-off compressor warm.
This prevents too much refrigerant from dissolving in the compressor oil and impairing lubrication during the next start.
How often it is activated depends on the software version and temperatures. With newer software versions from [9.6.0 / 9.6.1](https://bosch-buderus-wp.github.io/en/docs/sw-versionen/#960--961), activation has been reduced, particularly in summer.

It is also important to know that electricity consumption is attributed to the heating system's energy monitoring when the system is in standby mode.
This means that electricity consumption for heating also occurs in summer, which can sometimes cause confusion.
...
Even in small systems with low total electricity consumption during operation, the relatively high system consumption results in a lower performance factor.
...
Anyone wishing to learn more about the operation, design and efficient operation of heat pumps beyond this technical overview will find an accessible introduction for laypeople and aspiring professionals in the book [Everything you need to know about heat pumps](https://link.amazon/B09tnIJmm){: rel="sponsored"} by energy-saving commissioner Carsten Herbert.

*Affiliate link: If you make a purchase, I may receive a commission. There are no additional costs for you.*
