...
headline: "Variants"
excerpt: "Bosch and Buderus heat pumps compared: identical models CS5800i/WLW176i, CS6800i/WLW186i, CS8800i/WLW186i MBE+ and more."
...
| Bosch Compress | Buderus model | Generation and main difference |
| :-------------- | :------------------------- | :----- |
| **CS3800i AW** | **WLW166i MBB AR** | new R290 entry-level series with 4, 6, 7, 10 and 13 kW |
| **CS5800i AW** | **WLW176i MB AR** | R290 series with 4, 5, 7, 10 and 12 kW; maximum 60 °C flow temperature |
| **CS6800i AW** | **WLW186i MB AR** | same output classes, but up to 75 °C flow temperature |
| **CS8800i AW** | **WLW186i MBE+ AR** | new R290 high-temperature series with 11, 13 and 15 kW |
| **CS7001i AW** | **WLW196i AR** | R410A; Bosch 5, 7, 9, 13, 17 / Buderus 4, 6, 8, 11, 14 |
| **CS7400i AW** | **WLW196i AR S+** | R410A; optimized for low noise; Bosch 5, 7 / Buderus 4, 6 |
...
- **Refrigerant:** R290
- **Output classes:** 4, 5, 7, 10 and 12 kW
- **Max. flow temperature:** 60 °C with CS5800i/WLW176i, 75 °C with CS6800i/WLW186i
- **Efficiency:** A+++ at W35; SCOP up to 4.77 at W35 and 3.64 at W55

### Outdoor unit

![Buderus and Bosch outdoor units](/assets/images/Außeneinheit.png)

Maximum heating output and COP of the 5 output classes:

| Type   | Bosch      | Buderus      |             A-10/W35 |              A-7/W35 |              A+2/W35 |              A+7/W35 |
| :---- | :--------- | :----------- | -------------------: | -------------------: | -------------------: | -------------------: |
...
Sources: [Bosch AW 4-7 OR-S](https://junkers-de-de-b.boschtt-documents.com/download/file/file/6721840669.pdf), [Bosch AW 10-12 OR-T](https://junkers-de-de-b.boschtt-documents.com/download/file/file/6721842854.pdf)
...
![Buderus and Bosch indoor units](/assets/images/Inneneinheit.png)

The indoor units differ according to the maximum possible flow temperature and the integrated tanks.
...
| :------------------------------- | :---- | :------ |
| without tank                    | 12 E  | E       |
| 70l buffer tank               | 12 MB | TP70    |
| 16l buffer and 180l DHW tank | 12 M  | TP180   |

## Other model families

Parts of this documentation can also be applied to the following air-to-water heat pumps.
Depending on the generation, however, the refrigerant circuit, hydraulics, control system, menu names and the entities available via EMS-ESP differ.

### Bosch CS3800i AW = Buderus WLW166i MBB AR

The **Bosch Compress 3800i AW** and the **Buderus Logatherm WLW166i MBB AR** are the new cost-oriented model family.

- **Refrigerant:** R290
- **Output classes:** 4, 6, 7, 10 and 13 kW
...
The series is intended for single-family and small multi-family houses in new construction and existing buildings.
The small outdoor units have one fan, while the two larger devices have two fans.

| Design | Bosch | Buderus | Integrated tank |
| :------- | :---- | :------ | :-------------------- |
| wall-mounted | AWEi | E | none |
| Tower | AWMi / AWMHi | T180 / T180 HK | approx. 180 l domestic hot water tank |

`AWMHi` or `T180 HK` adds a second mixed heating circuit.

Sources: [Bosch Compress 3800i AW](https://www.bosch-homecomfort.com/de/de/ocs/wohngebaeude/compress-3800i-aw-21901212-p/), [Buderus Logatherm WLW166i MBB AR](https://www.buderus.de/de/logathermwlw166imbbar)

### Bosch CS7001i AW = Buderus WLW196i AR

The **Bosch Compress 7001i AW** and the **Buderus Logatherm WLW196i AR** belong to the same older device family with R410A.

- **Refrigerant:** R410A
- **Output classes:** Bosch 5, 7, 9, 13 and 17; Buderus 4, 6, 8, 11 and 14
- **Max. flow temperature:** 62 °C
- **Efficiency:** A++ at W55; SCOP up to 5.16 at W35 and 3.70 at W55

| Design | Bosch | Buderus | Integrated tank |
| :------- | :---- | :------ | :-------------------- |
| wall-mounted | AWE / AWB | E / B | none |
...
The **Bosch Compress 7400i AW** and the **Buderus Logatherm WLW196i AR S+** are the sound-optimized variants of the older R410A family.
Depending on the year of manufacture and market, the designation CS7401i may also appear in technical documents.

- **Refrigerant:** R410A
- **Output classes:** Bosch 5 and 7; Buderus 4 and 6
- **Max. flow temperature:** 62 °C
- **Efficiency:** A++ at W55; SCOP up to 5.1 at W35 and 3.58 at W55

| Design | Bosch | Buderus | Integrated tank |
| :------- | :---- | :------ | :-------------------- |
| wall-mounted | AWE / AWB | E S+ / B S+ | none |
...
The selection is limited to two smaller output classes as a result.
...
The **Bosch Compress 8800i AW** and the **Buderus Logatherm WLW186i MBE+ AR** form the new powerful high-temperature model family for existing buildings:

- **Refrigerant:** R290
- **Output classes:** 11, 13 and 15 kW
- **Max. flow temperature:** 75 °C
- **Efficiency:** A+++ even at W55; SCOP up to 5.4 at W35 and 4.13 at W55

| Design | Bosch | Buderus | Integrated tank |
| :------- | :---- | :------ | :-------------------- |
| wall-mounted | AWEi D | E | none |
...
Instead of a rotary piston compressor, this model family uses a scroll compressor, which is somewhat more efficient but cannot modulate down as far, which could result in more frequent cycling.
