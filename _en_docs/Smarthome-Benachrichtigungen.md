...
permalink: /en/en/en/docs/smarthome/benachrichtigungen
toc: true
sidebar:
  nav: "en_docs"
lang: en
translation_url: /en/en/docs/smarthome/benachrichtigungen
...
With the help of the `Planner` of your ems-esp, you can trigger a notification for every change to the [entities](/en/en/docs/smarthome/entities) whose status interests you.
