...
The person named above is the controller within the meaning of Article 4 No. 7 GDPR.

---

**Open-source project**

This website is part of a non-commercial open-source project.
The source code is publicly available at:

[https://github.com/bosch-buderus-wp/](https://github.com/bosch-buderus-wp/)

Participation in the project does not establish any joint responsibility of contributors for the operation of the platform or the processing of personal data.
