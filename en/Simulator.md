...
5. Determination of the **COP** of the refrigeration circuit using the Carnot process based on the flow temperature and outdoor temperature
6. Determination of the **electrical power requirement** based on the building heating load and COP—plus the base load for pumps, electronics, ...
7. Determination of the **modulation** based on the current and maximum electrical power requirement
